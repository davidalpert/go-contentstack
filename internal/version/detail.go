...
// This file was generated by robots at 2023-02-12 18:48:46.799824 -0600 CST m=+0.032302001
package version
...
func NewVersionDetail() DetailStruct {
	s := DetailStruct{
		AppName:              "cs",
		BuildDate:            "2023-02-12 18:48:46.799824 -0600 CST m=+0.032302001",
		CoreVersion:          "0.2.1",
		GitBranch:            "main",
		GitCommit:            "a961e61",
		GitCommitSummary:     "build: goreleaser can't call make without a Makefile",
		GitDirty:             false,
		GitDirtyHasModified:  false,
		GitDirtyHasStaged:    false,
		GitDirtyHasUntracked: false,
		Version:              "0.2.1+a961e61",
	}

...
import (
	...
	"github.com/davidalpert/go-contentstack/internal/diagnostics/plaintext"
	"github.com/davidalpert/go-contentstack/internal/env"
...
const (
	ENVKEY_LOG_LEVEL  = "COMBINE_LOG_LEVEL"
	ENVKEY_LOG_FORMAT = "COMBINE_LOG_FORMAT"
	ENVKEY_LOG_FILE   = "COMBINE_LOG_FILE"
)
